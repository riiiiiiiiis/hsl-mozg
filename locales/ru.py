...
START = {
    "WELCOME_WITH_COURSES": (
        "Привет! 👋\n\n"
        "Хочешь научиться создавать сайты, приложения и ботов с помощью AI, даже если никогда не писал код?\n\n"
        "Здесь это возможно. Мы превращаем идеи в работающие продукты через диалог с нейросетями.\n\n"
        "Выбери свой путь:\n\n"
        "<b>БЕСПЛАТНЫЙ ВОРКШОП (12 сентября)</b>\n"
        "Попробуй свои силы и создай первое приложение за час. Запись — по кнопке ниже.\n\n"
        "<b>ПОЛНЫЙ КУРС (старт 1 октября)</b>\n"
        "Глубокое погружение на 4 недели, чтобы научиться запускать MVP и автоматизировать задачи."
    ),
    "WELCOME_NO_COURSES": (
        "Привет! 👋\n\n"
